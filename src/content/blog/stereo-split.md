...
<img src="/img/logic-convert-1.png" class="w-full rounded-lg" alt="TBC" loading="lazy">
2. Choose _Interleaved to Split_ as the **Stereo Conversion** option and hit **Save**
<img src="/img/logic-convert-2.png" class="w-full rounded-lg" alt="TBC" loading="lazy">
3. Wait for a moment...
4. Done!
<img src="/img/logic-convert-3.png" class="w-full rounded-lg" alt="TBC" loading="lazy">
